...
import { Text, Image, ScrollView, TouchableOpacity, Linking, View } from 'react-native';
...
const NewsDetailPage = () => {
  ...
  const { title, description, urlToImage, url, sourceName, author, publishedAt, content } = route.params;
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.articlePublishedAt}>{new Date(publishedAt).toLocaleString()}</Text>
